...
path_out                      = '/scratch2/dicerbo/destr/check/'
# global variables
redshift          = 19.0
Hubble            = 0.72
h2                = Hubble * Hubble
    ...
    while t < time:
        if ma <= 0. or press*mu_c*PROTONMASS/Temp < dmin or press*mu_c*PROTONMASS/Temp > dmax:
            if ma <= 0.:
                if index == 10:
                    if filectrl == 0:
                        line = '%e\t%e\t%e\t%e\t%e\t%e\n'%(0,np.log10(Rho_a), np.log10(Temp), ma, mh2, mh2*destr*tstep)
                        line += '%e\t%e\t%e\t%e\t%e\t%e\n'%(8e3,np.log10(Rho_a), np.log10(Temp), ma, mh2, mh2*destr*tstep)
                        line += '%e\t%e\t%e\t%e\t%e\t%e\n'%(16e3,np.log10(Rho_a), np.log10(Temp), ma, mh2, mh2*destr*tstep)
                        wr.write(line);
                    elif filectrl == 1:
                        line = '%e\t%e\t%e\t%e\t%e\t%e\n'%(8e3,np.log10(Rho_a), np.log10(Temp), ma, mh2, mh2*destr*tstep)
                        line += '%e\t%e\t%e\t%e\t%e\t%e\n'%(16e3,np.log10(Rho_a), np.log10(Temp), ma, mh2, mh2*destr*tstep)
            ...
            if index == 10 and ctrl == 3:
                line = '%e\t%e\t%e\t%e\t%e\t%e\n'%(t,np.log10(Rho_a), np.log10(Temp), ma, mh2, mh2*destr*tstep)
                wr.write(line)
                filectrl += 1
                ctrl = 0
            if tcontrol > 0.:
